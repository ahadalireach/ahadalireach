...
| ----------- | ------ | ------ |
| **Build Khalafat** |A platform developed to support Palestine, enabling users to donate, find alternative products, read informative blogs, and volunteer. |  [Demo](http://buildkhalafat.com) |
| **Goal Pulse** | A platform allow users to manage their goals effortlessly, designed for goal-oriented individuals.. |  [Demo](http://goalpulse.vercel.app) |
| **Color Craft** | A platform designed to help designers find and explore colors for their next design. |  [Demo](http://colorcraft-web.netlify.app) |
| **Roomista** | This site assists beach tourists by providing valuable details on available rooms for rent, enhancing their overall experience and convenience.| [Demo](http://roomista.netlify.app) |
| **The Fit Club** | Designed for fitness enthusiasts. Experience vibrant design, dynamic content, and seamless user interaction. | [Demo](http://thefitclub.netlify.app) |
